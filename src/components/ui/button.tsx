...
const classes = {
  ...
  normal:
    'bg-customBlue1 text-white text-light border border-transparent hover:text-customYellow1',
  custom: 'border border-transparent',
  outline:
    'border border-border-400 bg-transparent text-body hover:text-customYellow1 hover:bg-customBlue1',
  loading:
